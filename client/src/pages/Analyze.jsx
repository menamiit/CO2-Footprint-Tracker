...
// InputCard component for each activity category
...
// Slider component for easy input
const SliderInput = ({ label, value, onChange, min, max, unit }) => (
    <div>
        ...
        <div className="flex items-center space-x-4">
            ...
            />
            <span className="text-lg font-semibold text-gray-900 dark:text-white w-24 text-right">{value} {unit}</span>
        </div>
    </div>
);
...
const Dashboard = ()=> {
    ...
    const emissionFactors = useMemo(() => ({
        ...
        bus: 0.105, // per km
        train: 0.041, // per km
        flight: 0.25, // per km (short-haul average)
        electricity: 0.71, // per kWh (India average)
        redMeat: 2.66, // per 100g serving
    }), []);
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 sticky top-8 text-center">
                            <h3 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">Your Daily Footprint</h3>
                            ...
                            <div className="relative flex justify-center items-center my-6">
                                ...
                                <div className="absolute flex flex-col items-center">
                                    ...
                                    <span className="text-lg text-gray-500 dark:text-gray-400">kg CO<sub className="text-xs">2</sub>e</span>
                                </div>
                            </div>

                            <p className="text-gray-600 dark:text-gray-300 mt-4 h-12">
                                {getFootprintMessage()}
                            </p>

                            <div className="mt-6 text-left text-sm text-gray-500 dark:text-gray-400">
                                <h4 className="font-semibold text-gray-700 dark:text-gray-200 mb-2">What this means:</h4>
